/**
 * Generates icon JSON data files for the HPA.SurveyFlow.Api IconsController.
 * Run: node generate-icons.mjs
 * Reads from ./node_modules/react-icons/
...
const outputDir = join(__dir, 'HPA.SurveyFlow.Api/icons');
