    ...
    <div class="space-y-4">
      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-sm text-gray-500 mt-0.5">Define conditions that trigger email or SMS notifications when a form is submitted.</p>
        </div>
      ...
      @if (!loading() && rules().length === 0) {
        <div class="text-center py-16 border-2 border-dashed border-gray-200 rounded-xl">
          ...
          <p class="text-gray-400 text-sm mt-1">Add a rule to send notifications based on submission field values.</p>
