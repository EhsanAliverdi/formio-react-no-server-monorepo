          ...
          <div class="space-y-4">
            <div class="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5">
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400 mb-5">
                Send emails to users for notifications, password resets, and form submissions.
              </p>
        ...
        @if (activeTab() === 'mex') {
          <div class="space-y-4">
            <div class="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5">
              ...
              <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                <div class="lg:col-span-2">
                  <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">MEX API Base URL</label>
...
export class IntegrationsComponent implements OnInit {
  ...
  isTabEnabled(tab: Tab): boolean {
    ...
    if (tab === 'mex') return this.mexEnabled;
    return false;
  }
  ...
  save(): void {
    ...
    // Only include secrets if the user typed something new
