...
export class AdminLayoutComponent implements OnInit {
  ...
  readonly navItems: NavItem[] = [
    ...
    { name: 'Categories', path: '/admin/categories', icon: 'M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A2 2 0 013 12V7a4 4 0 014-4z' },
    { name: 'Pages', path: '/admin/pages', icon: 'M4 5a2 2 0 012-2h8l6 6v10a2 2 0 01-2 2H6a2 2 0 01-2-2V5z|M14 3v6h6|M8 13h8|M8 17h5' },
    ...
    { name: 'Report', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z', subItems: [
      { name: 'Reports', path: '/admin/reporting/reports' },
      { name: 'Datasets', path: '/admin/reporting/datasets' },
      { name: 'Dashboards', path: '/admin/reporting/dashboards' },
    ] },
