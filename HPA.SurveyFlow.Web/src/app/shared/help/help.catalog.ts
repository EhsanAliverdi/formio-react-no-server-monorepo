...
export const HELP_CATALOG = {
  ...
  'admin.categories.description': topic('Category description', 'Optional category text shown in the public page header when header descriptions are enabled. Form cards use each form public description instead.'),
  ...
  'admin.categories.image-icon': topic('Category image and icon', 'Stores an optional category-level image or fallback icon for the public page header. These values are separate from each form card image and fallback icon.'),
