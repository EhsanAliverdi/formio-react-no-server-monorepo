...
namespace HPA.SurveyFlow.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260604233301_AddReportTemplateSourceType")]
    partial class AddReportTemplateSourceType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HPA.SurveyFlow.Domain.Entities.Dashboard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("HPA.SurveyFlow.Domain.Entities.DashboardCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("HPA.SurveyFlow.Domain.Entities.ReportTemplate", b =>
                {
                    ...
                    b.Property<string>("SourceType")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                        .HasDefaultValue("form_submissions")
            ...
            modelBuilder.Entity("HPA.SurveyFlow.Domain.Entities.Terminal", b =>
                {
            ...
            modelBuilder.Entity("HPA.SurveyFlow.Domain.Entities.Dashboard", b =>
                {
                    ...
                    b.HasOne("HPA.SurveyFlow.Domain.Entities.Terminal", "Terminal")
                        .WithMany()
                        .HasForeignKey("TerminalCode")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("HPA.SurveyFlow.Domain.Entities.DashboardCard", b =>
                {
                    b.HasOne("HPA.SurveyFlow.Domain.Entities.Dashboard", "Dashboard")
                        .WithMany("Cards")
