      ...
      @if (loading()) {
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          @for (f of formCards(); track f.id) {
            <div class="w-full bg-white p-6 border border-gray-200 rounded-xl shadow-sm">
              <!-- Icon area -->
              <div class="w-full h-40 rounded-xl mb-6 bg-gray-50 text-gray-700 flex items-center justify-center">
              ...
              <div>
                ...
                @if (f.description) {
                  <div class="mt-2 text-sm text-gray-600">{{ f.description }}</div>
                }
